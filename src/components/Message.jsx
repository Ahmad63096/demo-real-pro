...
function Message() {
  ...
  const handleButtonClick = (buttonText) => {
    ...
    const buttonResponses = {
      "Property Acquisition & Sales": "I want to know about Property Acquisition & Sales.",
      "Property Management": "I want to know about Property Management.",
      "Real Estate Investment Opportunities": "I want to know about Real Estate Investment Opportunities.",
      "Business & Financial Consulting": "I want to know about Business & Financial Consulting."
    };
  ...
  useEffect(() => {
    const fetchGreetingMessage = async () => {
      try {
        const data = "Hey there! I’m your virtual assistant at Real Pro. How are you today?😊";
